...
Future analyses should seek to improve predictive accuracy on unseen data through the use of larger training datasets, and potentially through application of regularization methods or alternative model types for time-to-event analysis. 
